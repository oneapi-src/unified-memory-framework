...
execute_process(
  COMMAND "/usr/bin/git" show-ref v1.19.2
  WORKING_DIRECTORY "/home/kluszcze/unified-memory-framework/_deps/level-zero-loader-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.19.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.19.2")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v1.19.2
  WORKING_DIRECTORY "/home/kluszcze/unified-memory-framework/_deps/level-zero-loader-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/oneapi-src/level-zero.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kluszcze/unified-memory-framework/_deps/level-zero-loader-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kluszcze/unified-memory-framework/_deps/level-zero-loader-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
