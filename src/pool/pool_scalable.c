...
static const struct ctl_node CTL_NODE(by_handle)[] = {
    CTL_LEAF_RO(tracking_enabled), CTL_NODE_END};

void initialize_pool_ctl(void) {
    pool_scallable_ctl_root = ctl_new();
    CTL_REGISTER_MODULE(pool_scallable_ctl_root, by_handle);
}
