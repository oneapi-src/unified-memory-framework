...
static umf_result_t
CTL_READ_HANDLER(ipc_enabled)(void *ctx, umf_ctl_query_source_t source,
...
static umf_result_t os_ctl(void *hProvider,
...
static umf_result_t os_post_initialize(const void *params, void *provider) {
    (void)params;
    (void)provider;
