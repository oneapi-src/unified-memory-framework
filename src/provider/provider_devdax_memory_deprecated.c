...
// DevDax Provider is not supported on Windows
#if defined(_WIN32) || defined(UMF_NO_HWLOC)

umf_memory_provider_ops_t *umfDevDaxMemoryProviderOps_0_10(void) {
    // not supported
...
// The ops structure for the DevDax Memory Provider has been changed between
// UMF 0.10 and 0.11 (in 0.10 there was no "free()" method)

extern umf_memory_provider_ops_0_11_t UMF_DEVDAX_MEMORY_PROVIDER_OPS_0_11;
static umf_memory_provider_ops_0_10_t UMF_DEVDAX_MEMORY_PROVIDER_OPS_0_10;

#if !defined(__APPLE__)
// Set 0_10 version as the default one for dlsym()
asm(".symver "
    "umfDevDaxMemoryProviderOps_0_10,umfDevDaxMemoryProviderOps@@UMF_0.10");
#endif

umf_memory_provider_ops_0_10_t *umfDevDaxMemoryProviderOps_0_10(void) {
    umf_memory_provider_ops_0_11_t ops = UMF_DEVDAX_MEMORY_PROVIDER_OPS_0_11;
    ...
    UMF_DEVDAX_MEMORY_PROVIDER_OPS_0_10 = ops_0_10;
    return &UMF_DEVDAX_MEMORY_PROVIDER_OPS_0_10;
}
