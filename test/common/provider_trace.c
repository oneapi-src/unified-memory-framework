...
static enum umf_result_t traceInitialize(void *params, void **pool) {
    struct umf_provider_trace_params_priv *trace_pool =
        (struct umf_provider_trace_params_priv *)malloc(
            sizeof(struct umf_provider_trace_params_priv));
    if (NULL == trace_pool) {
...
static enum umf_result_t traceAlloc(void *provider, size_t size,
    ...
    struct umf_provider_trace_params_priv *traceProvider =
        (struct umf_provider_trace_params_priv *)provider;
