...
static const char *Native_error_str[] = {
    ...
    "lazy purging failed",  // UMF_DEVDAX_RESULT_ERROR_PURGE_LAZY_FAILED
...
auto defaultParams = umfDevDaxMemoryProviderParamsDefault(
    (char *)UMF_TESTS_DEVDAX_PATH, UMF_TESTS_DEVDAX_SIZE);
...
TEST_P(umfProviderTest, purge_lazy_INVALID_POINTER) {
    ...
    verify_last_native_error(provider.get(),
                             UMF_DEVDAX_RESULT_ERROR_PURGE_LAZY_FAILED);
}
