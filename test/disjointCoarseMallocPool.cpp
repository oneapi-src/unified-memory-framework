...
TEST_F(test, disjointCoarseMallocPool_basic) {
    ...
    coarse_memory_provider_params_t coarse_memory_provider_params = {
        ...
        init_buffer_size,
        true,  // trace
        false, // WA_do_not_free_upstream
    };

    umf_memory_provider_handle_t coarse_memory_provider;
    umfMemoryProviderCreate(umfCoarseMemoryProviderOps(),
...
TEST_F(test, disjointCoarseMMapPool_random) {
    ...
    coarse_memory_provider_params_t coarse_memory_provider_params = {
        ...
        false, // immediate_init - this is used only with the upstream provider
        buf,   // ptr to preallocated memory
        init_buffer_size,
        true,  // trace
        false, // WA_do_not_free_upstream
    };
